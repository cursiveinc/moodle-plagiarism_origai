...
$string['privacy:metadata:plagiarism_origai_client:coursemodule'] = 'El ID del módulo del curso donde se realizó el envío.';
$string['privacy:metadata:plagiarism_origai_client:submissiondate'] = 'La fecha en que se realizó el envío.';
$string['privacy:metadata:plagiarism_origai_client:moodleuserid'] = 'El ID de usuario de Moodle de la persona que realizó el envío.';
$string['privacy:metadata:plagiarism_origai_client:submissionref'] = 'El identificador de referencia del envío.';
...
$string['ai'] = 'IA';
$string['editscansettings'] = 'Editar configuración de escaneo';
$string['excludeurlssection'] = 'Excluir URLs';
$string['excludeurlsdesc'] = 'Agregar URLs que deben excluirse de la detección de plagio (una por línea)';
$string['excludecitations'] = 'Excluir citas';
$string['excludequotes'] = 'Excluir comillas';
$string['excludereferences'] = 'Excluir referencias/bibliografías';
$string['excludetoc'] = 'Excluir tabla de contenidos';
$string['excludeurlslabel'] = 'Ingrese URLs/dominios para excluir, uno por línea';
$string['excludetemplates'] = 'Elegir archivo';
$string['invalidurl'] = 'URL inválida';
$string['omitsettings'] = 'Configuración de omisión';
$string['omitsettingsdesc'] = 'Configure qué contenido excluir de los escaneos de detección de plagio.';
$string['original'] = 'Original';
$string['real'] = 'Real';
$string['scansettingstitle'] = 'Editar configuración de escaneo';
$string['scansettingssave'] = 'Guardar configuración de escaneo';
$string['uploadtemplate'] = 'Subir plantilla de exclusión';
$string['uploadtemplatedesc'] = 'Subir un archivo de plantilla que contenga secciones para excluir de los escaneos.';
$string['openscansettings'] = 'Abrir configuración de escaneo';
