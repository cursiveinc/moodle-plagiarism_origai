...
$string['editscansettings'] = '스캔 설정 편집';
...
$string['excludecitations'] = '인용 제외';
$string['excludequotes'] = '인용문 제외';
$string['excludereferences'] = '참고문헌/서지 제외';
$string['excludetemplates'] = '파일 선택';
$string['excludetoc'] = '목차 제외';
$string['excludeurlsdesc'] = '표절 탐지에서 제외할 URL 추가 (한 줄에 하나씩)';
$string['excludeurlslabel'] = '제외할 URL/도메인 입력, 한 줄에 하나씩';
$string['excludeurlssection'] = 'URL 제외';
$string['failmsg'] = '실패';
$string['fake'] = '가짜';
...
$string['invalidurl'] = '잘못된 URL';
$string['lite'] = '영어';
$string['matchinfo'] = '경기 정보';
$string['matchpercentage'] = '일치 %:';
$string['multilang'] = '멀티 랭';
$string['nopageaccess'] = '이 페이지에 대한 액세스 거부';
$string['omitsettings'] = '생략 설정';
$string['omitsettingsdesc'] = '표절 탐지 스캔에서 제외할 콘텐츠를 구성합니다.';
$string['openscansettings'] = '스캔 설정 열기';
...
$string['privacy:metadata:plagiarism_origai_client:coursemodule'] = '제출이 이루어진 과정 모듈 ID입니다.';
$string['privacy:metadata:plagiarism_origai_client:moodleuserid'] = '제출한 사람의 Moodle 사용자 ID입니다.';
$string['privacy:metadata:plagiarism_origai_client:submission_content'] = '제출된 콘텐츠는 표절 신고를 위해 OriginalityAI로 전송됩니다.';
$string['privacy:metadata:plagiarism_origai_client:submissiondate'] = '제출이 이루어진 날짜입니다.';
$string['privacy:metadata:plagiarism_origai_client:submissionref'] = '제출 참조 식별자입니다.';
...
$string['scansettingssave'] = '스캔 설정 저장';
$string['scansettingstitle'] = '스캔 설정 편집';
$string['score'] = '점수:';
...
$string['uploadtemplate'] = '제외 템플릿 업로드';
$string['uploadtemplatedesc'] = '스캔에서 제외할 섹션이 포함된 템플릿 파일을 업로드합니다.';
