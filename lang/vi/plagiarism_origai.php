...
$string['editscansettings'] = 'Chỉnh sửa cài đặt quét';
...
$string['excludecitations'] = 'Loại trừ trích dẫn';
$string['excludequotes'] = 'Loại trừ dấu ngoặc kép';
$string['excludereferences'] = 'Loại trừ tham khảo/thư mục';
$string['excludetemplates'] = 'Chọn tập tin';
$string['excludetoc'] = 'Loại trừ mục lục';
$string['excludeurlsdesc'] = 'Thêm các URL cần loại trừ khỏi việc phát hiện đạo văn (mỗi dòng một URL)';
$string['excludeurlslabel'] = 'Nhập URL/tên miền cần loại trừ, mỗi dòng một';
$string['excludeurlssection'] = 'Loại trừ URL';
...
$string['omitsettings'] = 'Cài đặt bỏ qua';
$string['omitsettingsdesc'] = 'Cấu hình nội dung nào cần loại trừ khỏi quét phát hiện đạo văn.';
$string['openscansettings'] = 'Mở cài đặt quét';
...
$string['privacy:metadata:plagiarism_origai_client:coursemodule'] = 'ID mô-đun khóa học nơi bài nộp được thực hiện.';
$string['privacy:metadata:plagiarism_origai_client:moodleuserid'] = 'ID người dùng Moodle của người thực hiện bài nộp.';
...
$string['privacy:metadata:plagiarism_origai_client:submissiondate'] = 'Ngày thực hiện bài nộp.';
$string['privacy:metadata:plagiarism_origai_client:submissionref'] = 'Mã định danh tham chiếu bài nộp.';
...
$string['scansettingssave'] = 'Lưu cài đặt quét';
$string['scansettingstitle'] = 'Chỉnh sửa cài đặt quét';
...
$string['uploadtemplate'] = 'Tải lên mẫu loại trừ';
$string['uploadtemplatedesc'] = 'Tải lên tập tin mẫu chứa các phần cần loại trừ khỏi quét.';
