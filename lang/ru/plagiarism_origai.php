...
$string['editscansettings'] = 'Редактировать настройки сканирования';
...
$string['excludecitations'] = 'Исключить цитаты';
$string['excludequotes'] = 'Исключить кавычки';
$string['excludereferences'] = 'Исключить ссылки/библиографии';
$string['excludetemplates'] = 'Выбрать файл';
$string['excludetoc'] = 'Исключить оглавление';
$string['excludeurlsdesc'] = 'Добавить URL, которые должны быть исключены из обнаружения плагиата (один на строку)';
$string['excludeurlslabel'] = 'Введите URL/домены для исключения, один на строку';
$string['excludeurlssection'] = 'Исключить URL';
...
$string['invalidurl'] = 'Недопустимый URL';
$string['lite'] = 'Английский язык';
$string['matchinfo'] = 'Информация о матче';
$string['matchpercentage'] = 'Соответствие %:';
$string['multilang'] = 'Мультиязычный';
$string['nopageaccess'] = 'Доступ к этой странице запрещен';
$string['omitsettings'] = 'Настройки пропуска';
$string['omitsettingsdesc'] = 'Настройте, какое содержание исключить из сканирования на плагиат.';
$string['openscansettings'] = 'Открыть настройки сканирования';
...
$string['scansettingssave'] = 'Сохранить настройки сканирования';
$string['scansettingstitle'] = 'Редактировать настройки сканирования';
$string['score'] = 'Зачет:';
...
$string['uploadtemplate'] = 'Загрузить шаблон исключения';
$string['uploadtemplatedesc'] = 'Загрузите файл шаблона, содержащий разделы для исключения из сканирования.';
