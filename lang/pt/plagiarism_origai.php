...
$string['privacy:metadata:plagiarism_origai_client:coursemodule'] = 'O ID do módulo do curso onde a submissão foi feita.';
$string['privacy:metadata:plagiarism_origai_client:submissiondate'] = 'A data em que a submissão foi feita.';
$string['privacy:metadata:plagiarism_origai_client:moodleuserid'] = 'O ID de utilizador Moodle da pessoa que fez a submissão.';
$string['privacy:metadata:plagiarism_origai_client:submissionref'] = 'O identificador de referência da submissão.';
...
$string['editscansettings'] = 'Editar configurações de digitalização';
$string['excludeurlssection'] = 'Excluir URLs';
$string['excludeurlsdesc'] = 'Adicionar URLs que devem ser excluídos da detecção de plágio (um por linha)';
$string['excludecitations'] = 'Excluir citações';
$string['excludequotes'] = 'Excluir aspas';
$string['excludereferences'] = 'Excluir referências/bibliografias';
$string['excludetoc'] = 'Excluir índice';
$string['excludeurlslabel'] = 'Inserir URLs/domínios para excluir, um por linha';
$string['excludetemplates'] = 'Escolher ficheiro';
$string['invalidurl'] = 'URL inválido';
$string['omitsettings'] = 'Configurações de omissão';
$string['omitsettingsdesc'] = 'Configure que conteúdo excluir das digitalizações de detecção de plágio.';
$string['original'] = 'Original';
$string['real'] = 'Real';
$string['scansettingstitle'] = 'Editar configurações de digitalização';
$string['scansettingssave'] = 'Guardar configurações de digitalização';
$string['uploadtemplate'] = 'Carregar modelo de exclusão';
$string['uploadtemplatedesc'] = 'Carregar um ficheiro modelo contendo secções para excluir das digitalizações.';
$string['openscansettings'] = 'Abrir configurações de digitalização';
